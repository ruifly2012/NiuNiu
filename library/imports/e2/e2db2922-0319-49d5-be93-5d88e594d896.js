"use strict";
cc._RF.push(module, 'e2db2kiAxlJ1b6TXYjllNiW', 'TalkMenuController');
// prefabs/TalkMenuController/TalkMenuController.js
...
cc.Class({
    ...
    openMenu: function openMenu() {
        if (this.isOpened == true) this.closeMenu();else {
    ...
    onKeyDown: function onKeyDown(event) {
        ...
        switch (event.keyCode) {
            case 69:
                ...
                if (this.nextNextCounter > 9) this.nextNextCounter = 0;
            ...
            case 68:
                ...
                this.nextCounter++;
                if (this.nextCounter > 9) this.nextCounter = 0;
            ...
            case 65:
                ...
                this.PreCounter++;
                if (this.PreCounter > 9) this.PreCounter = 0;
            ...
            case 81:
                ...
                this.PrePreCounter++;
                if (this.PrePreCounter > 9) this.PrePreCounter = 0;
