...
@ccclass
export default class ShowCard extends cc.Component {
    ...
    @property(cc.Node)
    interface: cc.Node = null;

    @property(cc.Node)
    firstNum: cc.Node = null;

    @property(cc.Node)
    secondNum: cc.Node = null;

    @property(cc.Node)
    thirdNum: cc.Node = null;

    @property(cc.Node)
    totalNum: cc.Node = null;

    @property(cc.Node)
    cardError: cc.Node = null;
    ...
    onLoad(){
        ...
        global.Instance.EventListener.on("CardSelected", function (event) {
            self.fillTheBox();

        });
        global.Instance.EventListener.on("CardUnselected", function (event) {
            self.unfillTheBox();
        });
    }
